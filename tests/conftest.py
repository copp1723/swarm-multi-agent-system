...
def mock_openrouter_service():
    ...
    mock.chat_completion.return_value = {
        'choices': [{
            'message': {
                'content': 'Test response from mock OpenRouter'
            }
        }]
    }
...
def mock_supermemory_service():
    ...
    mock.retrieve_context.return_value = {
        'context': 'Test context from mock Supermemory'
    }
    mock.search_memories.return_value = {
        'results': [{'content': 'Test memory', 'score': 0.9}]
    }
    return mock
...
def mock_mailgun_service():
    ...
    mock.get_domain_stats.return_value = {
        'delivered': 100,
        'failed': 0
    }
    return mock
