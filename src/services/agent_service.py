...
from src.services.openrouter_service import OpenRouterService, ChatMessage, ChatResponse
...
class AgentService:
    ...
    def __init__(self, openrouter_service: OpenRouterService, supermemory_service: SupermemoryService = None):
    ...
    def chat_with_agent(self, agent_id: str, message: str, conversation_history: List[Dict[str, str]] = None, model: str = None) -> ChatResponse:
