...
class FlexibleConfig:
    ...
    def _load_security_config(self) -> SecurityConfig:
        ...
        if not secret_key:
            ...
            logger.warning("No SECRET_KEY provided, using generated key (not suitable for production)")
    ...
    def _initialize_services(self):
        ...
        self.services['mcp_filesystem'] = ServiceConfig(
            ...
            config={
                ...
                'allowed_extensions': os.getenv('MCP_ALLOWED_EXTENSIONS', '.txt,.md,.json,.csv,.py').split(',')
            }
        )
    ...
    def update_service_status(self, service_name: str, status: ServiceStatus, error_message: Optional[str] = None):
